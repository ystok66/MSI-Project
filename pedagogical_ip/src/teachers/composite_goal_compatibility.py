"""Composite Goal Compatibility — Structural prior for composite goal separation.  [STATUS: DEPRECATED]

DEPRECATED as of 2026-04-01 (Step 4 cleanup). The compatibility bonus was
proven redundant: no_bonus ≡ legacy_bonus in all experiments. Use structural
prior (compositional_goal_prior.py) instead. This file is retained in-place
for backward import compatibility with tests and experiment scripts.
Canonical copy in: archive/deprecated/composite_goal_compatibility.py
