"""Necessity Gate Variants — Step 5A.1.  [STATUS: NOT PROMOTING]

NOT PROMOTING as of 2026-04-01 cleanup. Step 5A.2 concluded: GateDiffRate = 0
on all 300 CGC-v2 episodes; gate doesn't differentiate in 2-path regime.
Module preserved for potential >2-path future work. Archived: archive/ablations/.
