"""Continuous Reward Weight Shadow — Step 5B.  [STATUS: FROZEN]

FROZEN as of 2026-04-01 cleanup. Step 5B concluded: rigid discrete reward
table is sufficient; continuous residuals provide Δ NLL < 0.002. Module
preserved for paper comparison. Archived copy: archive/paper_baselines/.
